...
<body>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            <h2>Selamat Datang di Warung Ratu</h2>
            <p>Nikmati beragam menu lezat dengan cita rasa autentik Indonesia. Temukan menu favorit Anda di sini!</p>
            <a href="{{ route('rekomendasi') }}" class="btn">Lihat Rekomendasi</a>
        </div>
    </section>
